...
contract ERC721PresetMinterPauserAutoId is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable {
    ...
    //
    function mintWithTokenURI(address to, string memory _tokenURI) public  returns (bool) {
        _mint(to, _tokenIdTracker.current());
...
contract DappLearningCollectible is ERC721PresetMinterPauserAutoId{
  ...
  constructor(string memory tokenURI) ERC721PresetMinterPauserAutoId("Dapp-Learning", "DLDAO",tokenURI) {
    ADMIN = msg.sender;
  }
